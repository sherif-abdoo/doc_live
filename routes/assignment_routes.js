...
router.route('/submitAssignment/:assignId')
    .post(auth.studentProtect, assignMiddleWare.assignExists, assignMiddleWare.canSeeAssign ,
        assignMiddleWare.submittedBefore,assignControllers.submitAssignment)
